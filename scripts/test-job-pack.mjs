...
assert(pack.adapted_cv?.title === profile.title, "Adapted CV should preserve the canonical profile title.");
assert(Array.isArray(pack.adapted_cv?.metrics), "Adapted CV should retain verified profile metrics.");
